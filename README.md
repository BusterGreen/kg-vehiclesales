# kg-vehiclesales
Used Car Sale for KG-Core Framework :blue_car:
...
- [kg-garages](https://github.com/kgcore-framework/kg-garages) - Vehicle ownership
- [kg-phone](https://github.com/kgcore-framework/kg-phone) - For the e-mail
- [kg-logs](https://github.com/kgcore-framework/kg-logs) - Keep event logs
...
- Import `kg-vehiclesales.sql` in your database
...
ensure kg-vehiclesales
```

## Configuration
- To adjust tax, go to kg-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
